...
while getopts g:t:c:m:a:p:s:r:n:z option
do 
case "${option}"
in
g) gpu=${OPTARG};;
...
### Example: nohup bash scripts/run_supp.sh   -t configs/training_lr1e-1_bs512.cfg -m configs/model_resnet6_inplanes64.cfg -a configs/normact_bn1-BN_resblock-BNReLU_odeblock-LNReLU.cfg -p configs/pathes_zhores_supp.py -c configs/solver_tol1e-3.cfg -s Euler -r 0 -g 0 -n 2&
