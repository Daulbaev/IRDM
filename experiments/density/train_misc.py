...
def set_cnf_options(args, model):
    def _set(module):
        if isinstance(module, layers.CNF):
            ...
            # Set odeint settings
            module.odeint_type = args.odeint_type
            if args.n_nodes is not None:
                module.n_nodes = args.n_nodes
...
def build_model_tabular(args,
    ...
    def build_cnf():
        ...
        cnf = layers.CNF(
            ...
            return_intermediate_points=return_intermediate_points,
        )
        return cnf
    ...
    return model, chain  # we need chain for dt logging