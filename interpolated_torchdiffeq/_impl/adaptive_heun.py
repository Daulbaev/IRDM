...
class AdaptiveHeunSolver(AdaptiveStepsizeODESolver):
    ...
    def __init__(
        ...
        **unused_kwargs
        ...
        super(AdaptiveHeunSolver, self).__init__(func, y0, rtol, atol, **unused_kwargs)
    ...
    def _adaptive_heun_step(self, rk_state):
        ...
        (y1, f1, y1_error, k), inter_value, inter_time = _runge_kutta_step(self.func, y0, f0, t0, dt, tableau=_ADAPTIVE_HEUN_TABLEAU)
        self.f_t += [f0, f1]
        self.z_t += [y0, y1]
